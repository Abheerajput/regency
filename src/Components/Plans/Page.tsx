...
//       <div className="flex   xs:flex-col  justify-between gap-6 w-full ">

//         {/* Basic Plan */}
//         <div className='max-w-[380px] py-4 max-h-[600px]'>
//         <div className="bg-white w-full h-full  shadow-md rounded-lg pt-4 p-4 pb-0 text-center">
...
//           <p className="text-[40px] xl:text-[50px] font-inter justify-center font-semibold text-gray-800 mt-6  ">99.99</p>
//           </div>
//          <div className='bg-[#F9FAFB] mt-6 flex  flex-col p-4'>
//          <ul className="    flex  flex-col gap-4">
//             <li className="flex items-center font-inter gap-4"><Image src={tick} alt="" /> Secure Wills</li>
//             <li className="flex items-center  font-inter  gap-4"><Image src={tick} alt="" />Legal Review</li>
//             <li className="flex items-center  font-inter  gap-4"><Image src={tick} alt="" /> Easy Updates</li>
//             <li className="flex items-center  font-inter  gap-4"><Image src={tick} alt="" /> Chat Support</li>
//             <li className="flex items-center  font-inter  gap-4"><Image src={tick} alt="" /> Digital Storage</li>
//           </ul>
...
//         {/* Premium Plan */}
//         <div className='max-w-[380px] min-h-[684px]  '>
...
//           <p className="text-[40px] xl:text-[50px] font-inter text-white justify-center font-semibold   mt-6  ">199.99</p>
//           </div>
//           <div className='flex  justify-center  py-2'>
...
//             <li className="flex items-center font-inter  gap-4"><Image src={tick} alt="" /> Digital Storage</li>
//           </ul>
//           <button className="mt-6 bg-[#54BD95] w-full shadow-lg font-inter py-3 px-4 rounded-2xl text-white">            Go to pro
//           </button>
//           </div>
...
//           <p className="text-[40px] xl:text-[50px] font-inter justify-center font-semibold text-[#191A15] mt-6  ">299.99</p>
//           </div>
//            <div className='mt-6 p-4 bg-[#F9FAFB]'>
//           <ul className="   flex  flex-col gap-4">
//             <li className="flex items-center  font-inter gap-4"><Image src={tick} alt="" /> All the features of pro plan</li>
//             <li className="flex items-center font-inter gap-4"><Image src={tick} alt="" /> Secure Wills</li>
//             <li className="flex items-center  font-inter gap-4"><Image src={tick} alt="" /> Easy Updates</li>
//             <li className="flex items-center font-inter gap-4"><Image src={tick} alt="" /> Co-conception program</li>
//             <li className="flex items-center font-inter gap-4"><Image src={tick} alt="" /> Digital Storage</li>
//           </ul>
//           <button className="mt-6 text-green-500 w-full shadow-lg font-inter py-3 px-4 rounded-2xl bg-white">
//             Goto Business
